...
@Component({
  selector: 'app-qa-normal-view',
  templateUrl: './qa-normal-view.component.html',
  styleUrls: ['./qa-normal-view.component.scss']
})
export class QaNormalViewComponent implements OnInit {
